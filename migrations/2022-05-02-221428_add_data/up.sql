...
INSERT INTO Post
    (title, text)
    VALUES
    ('Hello TS-Read!!!', 'Hello ts-readWeclome to our new site! We have built this as a open marketplace of ideas, where users are free to discuss issues and share information in a secure way.');

INSERT INTO Post
    (title, text)
    VALUES
    ('I hate Windows', 'I have had enough with windows. Today my machine auto-updated to Windows 11, deleting my linux partitian in the process. Microsoft is a terible instutition that bringn about tyranny on the world with their bad products andn worse buisness pratices');
